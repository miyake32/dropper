...
var nameInStorage = "point1";
var deleteKeyInStorage = "point1";
...
function successGetCurPosi(position) {
	...
	location.assign("/dropper/demo/point1/index.jsp");
}
...
function getCurrentPosition() {
	if (navigator.geolocation) {
		...
		successGetCurPosi({coords:{latitude:35.644307 , longitude:139.699157}});
